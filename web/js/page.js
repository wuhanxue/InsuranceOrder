...
/*根据页面查询当页信息*/
function  findInfoBy(pageNumber) {
...
function findPageumber(item,fName) {
  ...
  var num=$(item).text();
    ...
    // console.log(li)
    // $(item).empty();
    // var span="<span  class='jPag-current' style='color: black; background-color: rgb(202, 230, 198); border: 1px solid rgb(104, 186, 100);'>"+num+"</span>";
    // li.append(span);
}
